...
export const YouTube_InvestBegin = 'https://www.youtube.com/channel/UCBThYbU2Thz5JLjgUI_1BIQ';
export const FB_InvestBegin = 'https://www.facebook.com/InvestBeginDE';
